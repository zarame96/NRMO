...
\item \textbf{HOLD}: governance/lifecycle state requiring deferral or
human review; not an Operational Mode and not synonymous with SHUTDOWN.
...
+---------------------------------------+
                  |
+---------------------------------------+
| UNIFIED NRMO CORE (veto/admissibility)|
+---------------------------------------+
                  |
+---------------------------------------+
...
\paragraph{Historical description and canonical interpretation.}
The preserved baseline described this component as a ``final judgement
engine for irreversibility avoidance and survival.'' Under the current
Normative Canon, that phrase does \textbf{not} grant sovereign decision
authority to an engine. The component is interpreted as a survival and
irreversibility evaluation/gating mechanism within the governed pipeline.
The Human/User retains final sovereign decision authority; NRMO retains
final governance, admissibility, and veto authority.

\begin{lstlisting}[basicstyle=\ttfamily\small,frame=single]
PURPOSE: decision_engine  # historical component label; no sovereign authority
