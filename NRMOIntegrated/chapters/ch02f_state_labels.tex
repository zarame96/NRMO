...
classifications $\to$ SOP input. SOP applies procedural and
action-space rules downstream; it does not acquire sovereign decision
authority. Final sovereign decision authority remains with the Human/User,
while NRMO retains final governance, admissibility, and veto authority.
}
...
NRMO retains final governance, admissibility, and veto authority. HST-N
feeds classifications; Type ZERO gates action space and mode. Downstream
execution operates only within the admitted set, and the Human/User retains
final sovereign adoption/execution authority.
...
\item Issue actions. HST-N does not execute; Type ZERO and SOP may gate or
structure action space, but they do not supersede Human sovereignty or NRMO
admissibility/veto authority.
