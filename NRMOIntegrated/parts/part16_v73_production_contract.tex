...
that reconstruction at or near verbatim for 5 of those items --- a
notable but coincidental convergence, not a claim that the
reconstruction effort somehow produced or was equivalent to the
original. \\[0.5em]
...
CLARIFIED & Adds precision, no new claim (1 needs disambiguation) & 5 \\
...
CONFLICT (resolved) & Resolved without Canon change & 1 \\
